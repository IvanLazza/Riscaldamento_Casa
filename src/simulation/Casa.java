...
public class Casa {
    ...
    public List<Riscaldamento> getImpiantiRiscaldamento() {
    ...
    public SimulationStatus clockTick(SimulationStatus simulationStatus) {
        simulationStatus = clock.tick(simulationStatus);
